...
<%
			...
			else
			{
				...
				{
					// Get the team and week to display
					out.println("<form action=\"editScores.jsp\" method=\"post\"><table><br>Week ... <input type=\"text\" name=\"weekNum\"></table><br><br><input type=\"submit\" name=\"submit\" value=\"Submit\"></form>") ;
				...
				else
				{
					...
					{
						// Display all drivers.
						query = "SELECT driverId, driverFirstName, driverLastName, raceTeamName, finishPosition, qualifyPosition, fastestLap FROM f1_driver" + weekNum + " ORDER BY driverLastName";

						rs = stmt.executeQuery(query);

						out.println("<form action=\"editScores.jsp\" method=\"post\">") ;
						...
						out.println("<tr><td width=\"250\" height=\"1\" bgcolor=\"#969696\"><font color=\"#FFFFFF\" size=2.5><b>Drivers</b></font></td>") ;
						...
						while (rs.next())
						{
							...
							out.println("<tr><td width=\"250\" height=\"1\" bgcolor=\"" + col + "\">" + rs.getString("driverLastName") + ", " + rs.getString("driverFirstName") + "</td>") ;
							...
							out.println("<input type=\"hidden\" name=\"id" + numPlayers + "\" value=\"" + rs.getInt("driverId") + "\">") ;
					...
					else
					{
						...
						query = "SELECT COUNT(*) AS messageCount FROM f1_driver" + weekNum ;
						...
						{
							query = "UPDATE f1_driver" + weekNum + " SET finishPosition = " + request.getParameter("finishPos" + i) + 
									", qualifyPosition = " + request.getParameter("qualifyPos" + i) + 
									", fastestLap = " + request.getParameter("fastestLap" + i) +
									" WHERE driverId = " + request.getParameter("id" + i) ;
