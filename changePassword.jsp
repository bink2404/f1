...
<%
			...
			else
			{
				if ((password1 == null) || (password1.equals("")))
				{
					...
					out.println("<form action=\"changePassword.jsp\" method=\"post\" name=\"changeForm\"><table><tr><td><input type=\"hidden\" name=\"id\" value=\"" + id + "\" readonly><tr><td><b>Current password</b>    <td><input type=\"password\" name=\"currentPassword\"><tr><td><b>New password</b>    <td><input type=\"password\" name=\"password1\"><tr><td><b>Re-Type Password</b>    <td><input type=\"password\" name=\"password2\"></table><br><input type=\"submit\" value=\"Submit\"></form>") ;
						...
						else
						{
							...
							else
							{
								...
								else
								{
									...
									if (LinesAffected != 1)
									{
										out.println("<font color=red>Problem changing the password, try again later</font><br>") ;
									}
									else
									{
										out.println("You password has been changed<br>") ;
