...
<%
			...
			else
			{
				...
				{
					query = "SELECT deadline FROM f1_admin WHERE updating >= 0" ;
					...
					out.println("<form action=\"setDeadline.jsp\" method=\"post\"><table><br>Deadline ... <input type=\"text\" value=\"" + rs.getString("deadline") + "\" name=\"deadline\"></table><br><br><input type=\"submit\" name=\"submit\" value=\"Submit\"></form>") ;
				...
				{
					// Now set the week
					query = "UPDATE f1_admin SET deadline = '" + deadline + "'";
